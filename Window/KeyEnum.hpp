#ifndef __WINDOW_KEYENUM_HPP__
#define __WINDOW_KEYENUM_HPP__

/*
    Define the button in 100% standard keyboard
    and scancode. Boilerplate conversion between
    different libraries' key enums.
*/
...
namespace HJUIK
{
	namespace Keyboard
	{
        ...
        sf::Keyboard::Scancode toSFMLKey(Key key);
        Key fromSFMLKey(sf::Keyboard::Scancode key);
        // More library binders
	}
}
